...
export const LoginForm = () => {
  ...
  return (
    <>
      <form
        onSubmit={onSubmit}
        className="sm:w-[50%] sm:h-[80%] flex justify-baseline items-center h-[90%] w-[100%] sm:pt-14 pt-20 gap-10 sm:gap-16 flex-col shadow-2xl border-1 border-slate-300 rounded-xl p-5 "
      >
